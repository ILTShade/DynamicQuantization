...
class ResNet18(nn.Module):
    def __init__(self, num_classes):
        ...
        # L1
        self.conv1 = quantize.QuantizeConv2d(input_fix_config, 3, 16, 3, padding = 1)
        self.bn1 = nn.BatchNorm2d(16)
        self.relu1 = nn.ReLU()
        # L2a
        self.conv2a_1 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn2a_1 = nn.BatchNorm2d(16)
        self.relu2a_1 = nn.ReLU()
        self.conv2a_2 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn2a_2 = nn.BatchNorm2d(16)
        self.relu2a = nn.ReLU()
        # L2b
        self.conv2b_1 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn2b_1 = nn.BatchNorm2d(16)
        self.relu2b_1 = nn.ReLU()
        self.conv2b_2 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn2b_2 = nn.BatchNorm2d(16)
        self.relu2b = nn.ReLU()
        # L3a
        self.conv3a_1 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, stride = 2, padding = 1)
        self.bn3a_1 = nn.BatchNorm2d(16)
        self.relu3a_1 = nn.ReLU()
        self.conv3a_2 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn3a_2 = nn.BatchNorm2d(16)
        self.conv3a_3 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 1, stride = 2)
        self.bn3a_3 = nn.BatchNorm2d(16)
        self.relu3a = nn.ReLU()
        # L3b
        self.conv3b_1 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn3b_1 = nn.BatchNorm2d(16)
        self.relu3b_1 = nn.ReLU()
        self.conv3b_2 = quantize.QuantizeConv2d(hidden_fix_config, 16, 16, 3, padding = 1)
        self.bn3b_2 = nn.BatchNorm2d(16)
        self.relu3b = nn.ReLU()
        # L4a
        self.conv4a_1 = quantize.QuantizeConv2d(hidden_fix_config, 16, 32, 3, stride = 2, padding = 1)
        self.bn4a_1 = nn.BatchNorm2d(32)
        self.relu4a_1 = nn.ReLU()
        self.conv4a_2 = quantize.QuantizeConv2d(hidden_fix_config, 32, 32, 3, padding = 1)
        self.bn4a_2 = nn.BatchNorm2d(32)
        self.conv4a_3 = quantize.QuantizeConv2d(hidden_fix_config, 16, 32, 1, stride = 2)
        self.bn4a_3 = nn.BatchNorm2d(32)
        self.relu4a = nn.ReLU()
        # L4b
        self.conv4b_1 = quantize.QuantizeConv2d(hidden_fix_config, 32, 32, 3, padding = 1)
        self.bn4b_1 = nn.BatchNorm2d(32)
        self.relu4b_1 = nn.ReLU()
        self.conv4b_2 = quantize.QuantizeConv2d(hidden_fix_config, 32, 32, 3, padding = 1)
        self.bn4b_2 = nn.BatchNorm2d(32)
        self.relu4b = nn.ReLU()
        # L5a
        self.conv5a_1 = quantize.QuantizeConv2d(hidden_fix_config, 32, 64, 3, stride = 2, padding = 1)
        self.bn5a_1 = nn.BatchNorm2d(64)
        self.relu5a_1 = nn.ReLU()
        self.conv5a_2 = quantize.QuantizeConv2d(hidden_fix_config, 64, 64, 3, padding = 1)
        self.bn5a_2 = nn.BatchNorm2d(64)
        self.conv5a_3 = quantize.QuantizeConv2d(hidden_fix_config, 32, 64, 1, stride = 2)
        self.bn5a_3 = nn.BatchNorm2d(64)
        self.relu5a = nn.ReLU()
        # L5b
        self.conv5b_1 = quantize.QuantizeConv2d(hidden_fix_config, 64, 64, 3, padding = 1)
        self.bn5b_1 = nn.BatchNorm2d(64)
        self.relu5b_1 = nn.ReLU()
        self.conv5b_2 = quantize.QuantizeConv2d(hidden_fix_config, 64, 64, 3, padding = 1)
